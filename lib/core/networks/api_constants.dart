class ApiConstants {
  static const String baseUrl = 'https://voipsys.space/api';
  ...
  static const String storagePath = 'https://voipsys.space/storage/';
  ...
  static String currencyFilterWithTypeAndDate({
    ...
    return '$baseUrl/currencies/historical?currency_id=$currencyId&type=$type&start_date=${DateTime(nowDate.year, nowDate.month, nowDate.day - 7)}';
  }
}
